...
class UserPartialUpdateTest {
  ...
  void shouldBeSerializableToJSON() throws JsonProcessingException {
    // given
    var request = new UserPartialUpdateRequest("example@gmail.com", "firstName", "lastName",
  ...
  void shouldBeDeserializableFromJSON() throws JsonProcessingException {
    // given
    var request = new UserPartialUpdateRequest("example@gmail.com", null, null, LocalDate.EPOCH,
        "Some address", "+123456789");
    String json = objectMapper.writeValueAsString(request);

    // when
    var deserializedRequest = objectMapper.readValue(json, UserPartialUpdateRequest.class);
  ...
  void shouldImplementEqualsAndHashCodeCorrectly() {
    EqualsVerifier.simple().forClass(UserPartialUpdateRequest.class).verify();
  }
}